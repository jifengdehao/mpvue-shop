<template>
  <div class="search">
    <div class="head">
      <div>
        <img
          ...
          alt="">
        <input type="text" confirm-type="search" focus="true" v-model="words" @input="tipsearch"
               @confirm="searchWords" placeholder="商品搜索">
    ...
    <div class="searchtips" v-if="words">
      <div @click="searchWords" v-if="tipsData.length!=0" :data-value="item.name" v-for="(item,index) in tipsData"
           :key="index">
        {{ item.name }}
      </div>
    ...
    <div class="history hotsearch">
      ...
      <div class="cont">
        <div @click="searchWords" v-for="(item,index) in hotData" :data-value="item.keyword" :class="{active:0==index}"
             :key="index">
          {{item.keyword}}
        </div>
      </div>
